...
let totalClicks = 0; //this var tracks how many times someone clicks the images
...
// let results = document.getElementById('results'); //declare the variable results to find results in html
let lastShownImages = [];//keeps track of images displayed
...
function Product(name, imgPath) {
  ...
  let cOne = Math.floor(Math.random() * 255);
  let cTwo = Math.floor(Math.random() * 255);
  let cThree = Math.floor(Math.random() * 255);
...
function randomImage() {
    let firstRandom = Math.floor(Math.random() * allProducts.length);
    let secondRandom = Math.floor(Math.random() * allProducts.length);
    let thirdRandom = Math.floor(Math.random() * allProducts.length);
